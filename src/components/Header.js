                ...
                <nav className="navbar navbar-static-top">
                    ...
                    <div className="navbar-custom-menu">
                        <ul className="nav navbar-nav">
                                    ...
                                    <li>
                                        ...
                                        <ul className="menu">
                                            ...
                                            <li>
                                                <a href={null}>
                                                    <div className="pull-left">
                                                        <img src="img/user3-128x128.jpg" className="img-circle" alt="User" />
                                                    </div>
                                                    <h4>
                                            ...
                                            <li>
                                                <a href={null}>
                                                    <div className="pull-left">
                                                        <img src="img/user4-128x128.jpg" className="img-circle" alt="User" />
                                                    </div>
                                                    <h4>
                                                        Developers
                            ...
                            <li>
                                <a href={null} data-toggle="control-sidebar"><i className="fa fa-gears"></i></a>
                            </li>
                        </ul>
                    </div>
                </nav>
