                ...
                <section className="sidebar">
                    ...
                    <ul className="sidebar-menu" data-widget="tree">
                        ...
                        <li className="treeview">
                            <a href={null}>
                                <i className="fa fa-files-o"></i> <span>Layout Options</span>
                                <span className="pull-right-container">
                        ...
                        <li className="treeview">
                            <a href={null}>
                                <i className="fa fa-pie-chart"></i> <span>Charts</span>
                                <span className="pull-right-container">
                                    <i className="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                        ...
                        <li className="treeview">
                            <a href={null}>
                                <i className="fa fa-laptop"></i> <span>UI Elements</span>
                                <span className="pull-right-container">
                                    <i className="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                        ...
                        <li className="treeview">
                            ...
                            <ul className="treeview-menu">
                                <li><a href={null}><i className="fa fa-circle-o"></i> Level One</a></li>
                                <li className="treeview">
                                    <a href={null}><i className="fa fa-circle-o"></i> Level One
                                        <span className="pull-right-container">
                                            <i className="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    <ul className="treeview-menu">
                                        <li><a href={null}><i className="fa fa-circle-o"></i> Level Two</a></li>
                                        <li className="treeview">
                                            <a href={null}><i className="fa fa-circle-o"></i> Level Two
                                                <span className="pull-right-container">
                                                    <i className="fa fa-angle-left pull-right"></i>
                                                </span>
                                            </a>
                                            <ul className="treeview-menu">
                                                <li><a href={null}><i className="fa fa-circle-o"></i> Level Three</a></li>
                                                <li><a href={null}><i className="fa fa-circle-o"></i> Level Three</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                        ...
                        <li><a href={null}><i className="fa fa-circle-o text-red"></i> <span>Important</span></a></li>
                        <li><a href={null}><i className="fa fa-circle-o text-yellow"></i> <span>Warning</span></a></li>
                        <li><a href={null}><i className="fa fa-circle-o text-aqua"></i> <span>Information</span></a></li>
                    </ul>
                </section>
