            ...
            <div className="content-wrapper">
                ...
                <section className="content-header">
                    ...
                    <ol className="breadcrumb">
                        <li><a href={null}><i className="fa fa-dashboard"></i> Home</a></li>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-xs-6">
                            ...
                            <div className="small-box bg-aqua">
                                ...
                                <a href={null} className="small-box-footer">More info <i className="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        ...
                        <section className="col-lg-7 connectedSortable">
                            ...
                            <div className="box box-success">
                                ...
                                <div className="box-body chat" id="chat-box">
                                    ...
                                    <div className="item">
                                        <img src="img/user4-128x128.jpg" alt="user" className="online" />

                                        <p className="message">
                                            <a href={null} className="name">
                                    ...
                                    <div className="item">
                                        <img src="img/user3-128x128.jpg" alt="user" className="offline" />
                                    ...
                                    <div className="item">
                                        <img src="img/user2-160x160.jpg" alt="user" className="offline" />
                                    ...
                                    <div className="pull-right box-tools">
                                        ...
                                        <div className="btn-group">
                                            ...
                                            <ul className="dropdown-menu pull-right" role="menu">
                                                <li><a href={null}>Add new event</a></li>
                                                <li><a href={null}>Clear events</a></li>
                                                <li className="divider"></li>
                                                <li><a href={null}>View calendar</a></li>
                                            </ul>
                                        </div>
